...
def _place_front_end_and_insulators(
    ...
    signal_cable, signal_cap, top_length_signal = _get_signal_cable(
        det_pos, thickness["cable"], unit_length, b
    )
    ...
    if det_pos == 1:
        ...
        geant4.PhysicalVolume(
            ...
            signal_cap,
            f"signal_cap_{det_unit.name}_string_{string_id}",
            b.mother_lv,
            b.registry,
        )

    hv_cable, hv_cap, top_length_hv = _get_hv_cable(det_pos, thickness["cable"], unit_length, b)
...
def _get_hv_cable(
    ...
    prefix = "cable_hv_top" if det_pos == 1 else "cable_hv"
    cable_name = f"{prefix}_{cable_length:.2f}"
    ...
    if det_pos == 1:
        ...
        hv_cap_1 = geant4.solid.Box(f"{cable_name}_cap1", 1, 1, 2, b.registry, "cm")
    ...
    return hv_cable_lv, hv_cap_lv, top_length
...
def _get_signal_cable(
    ...
    prefix = "cable_signal_top" if det_pos == 1 else "cable_signal"
    cable_name = f"{prefix}_{cable_length:.2f}"
    ...
    if det_pos == 1:
        ...
        signal_cap_part1 = geant4.solid.Box(f"{cable_name}_cap_part1", 1, 1, 2, b.registry, "cm")
    ...
    return signal_cable_lv, signal_cap_lv, top_length
