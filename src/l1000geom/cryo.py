...
def make_z_and_r(totalheight,neckheight,bodyheight,neckradius,barrelradius,shoulderfraction,bottomfraction):
    ...
    shoulderrfractions = [98.25,92.84,86.99,81.43,76.17,70.91,65.94,60.67,55.70,50.29,45.76,40.94,36.26,32.02,27.63,23.54,19.30,15.35,11.84,8.48,5.99,3.95,1.75,0.58]
...
def construct_moderator_stl(mod_material: g4.Material, reg: g4.Registry, mother_lv):
    ...
    for i in range(0,49):
        ...
        mod_pv = g4.PhysicalVolume([0, 0, 0], [0, 0, -850], mod_lv, mod_name, mother_lv, reg)
...
def construct_and_place_cryostat(instr: core.InstrumentationData) -> g4.PhysicalVolume:
    ...
    vgapthickness_barrel = 400
    vgapthickness_bottom = 100    
    icryo_thickness = 40
    ...
    skirt_solid = g4.solid.Tubs("skirt_sol", skirtradius - skirtthickness, skirtradius, skirtheight - (ocryo_thickness*7), 0, 2 * pi, instr.registry, "mm")
    skirt_lv = g4.LogicalVolume(skirt_solid, instr.materials.metal_steel, "skirt", instr.registry)
    foot_solid = g4.solid.Tubs("foot_sol", skirtradius, skirtradius+footwidth, footheight, 0, 2 * pi, instr.registry, "mm")
    foot_lv = g4.LogicalVolume(foot_solid, instr.materials.metal_steel, "foot", instr.registry)
    
    ocryo_z, ocryo_r = make_z_and_r(totalheight,neckheight,bodyheight,neckradius,barrelradius,shoulderfraction,bottomfraction)
    ...
    vac_z, vac_r = make_z_and_r(totalheight,neckheight,bodyheight,neckradius,barrelradius,shoulderfraction,bottomfraction)
    ...
    icryo_z, icryo_r = make_z_and_r(totalheight,neckheight,bodyheight,neckradius,barrelradius,shoulderfraction,bottomfraction)
    ...
    atmlar_z, atmlar_r = make_z_and_r(totalheight,neckheight,bodyheight,neckradius,barrelradius,shoulderfraction,bottomfraction)
